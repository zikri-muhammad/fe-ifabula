...
export default function RegisterPage() {
    ...
    return (
        <div className='min-h-screen w-full overflow-y-auto bg-[#FAFAFB] relative'>
            ...
            <div className='z-8 mt-10 md:mt-0 absolute w-full h-full items-center flex flex-col '>
                <div className='w-full h-full  flex flex-col items-center justify-center'>
                    ...
                    <div className='w-auto h-auto md:w-[560px] md:h-[597px] p-5 md:p-12 rounded-3xl bg-white'>
                        <div className='w-full h-full'>
                            <div className='w-full h-full flex flex-col justify-between '>
                                <div className="flex flex-col space-y-4">
                                    ...
                                    <InputPassword change={changeForm} name="password" label={"Password"} />
                                </div>
                                <div className="w-full md:flex space-x-0 md:space-x-4 space-y-2 md:space-y-0">
                                    <Link href={`/auth/signin`} className="w-full md:w-[30%] ">
                                        <ButtonSolid className={"w-full bg-primary text-[#696974] px-4 py-3"} title="Login" />
                                    </Link>
                                    <ButtonSolid click={submitForm} className={" w-full md:w-[70%] py-3 bg-primary"} title="Register" />
                                </div>
                            </div>
                        </div>
                    </div>
